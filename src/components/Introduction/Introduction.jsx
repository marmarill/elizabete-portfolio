...
export default function Introduction() {
 ...
 <div className={styles.introductionContainer}>
    ...
    <p className={styles.subTextLeft}>
      ...
      told with minimal number of elements. Therefore, I put this as my priority – to think about sustainability in the context of digital design.
  </p>
  <p className={styles.subTextRight}>
      Through empathy and my interest in society and its well-being, I have developed an interest in human-centered design, especially UX/UI. I am interested in designing solutions that not only fulfill functional needs but also initiate meaningful conversations about socially important topics.
  </p>
  </div>
</div>
  );
